            ...
            {!success && (<div>
                ...
                <div className={styles.Basket}>
                    ...
                    <div className={styles.wrapperProducts}>
                        {mode == 'with_formats' ? (basketProducts && (basketProducts.map((product, index) => (<ProductBasket product={product} toggleSelect={(element) => toggleSelect(element, product)} checkSelectPhoto={() => { return false; }} selectPhotos={[]} key={index} openPreviewModal={handleOpenPreviewModal} onOpen={(photoProduct) => handleOpenEdit(photoProduct, product)} dir={directories.photos} mode={mode}/>))))
                : (<ProductBasket images={order.images} toggleSelect={(element) => toggleSelect(element)} checkSelectPhoto={() => { return false; }} selectPhotos={[]} openPreviewModal={handleOpenPreviewModal} dir={directories.photos} mode={mode}/>)}
                    </div>
                </div>
