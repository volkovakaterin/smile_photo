    ...
    return (<article className="pt-16 pb-16">
      ...
      <div className="flex flex-col items-center gap-4 pt-8">
        <div className="container">
          ...
          {post.relatedPosts && post.relatedPosts.length > 0 && (<RelatedPosts className="mt-12 max-w-[52rem] lg:grid lg:grid-cols-subgrid col-start-1 col-span-3 grid-rows-[2fr]" docs={post.relatedPosts.filter((post) => typeof post === 'object')}/>)}
        </div>
      </div>
    </article>);
}
