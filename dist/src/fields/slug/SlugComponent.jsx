...
import './index.scss';
export const SlugComponent = ({ field, fieldToUse, checkboxFieldPath: checkboxFieldPathFromProps, path, readOnly: readOnlyFromProps, }) => {
    const { label } = field;
    ...
    return (<div className="field-type slug-field-component">
...
//# sourceMappingURL=SlugComponent.jsx.map