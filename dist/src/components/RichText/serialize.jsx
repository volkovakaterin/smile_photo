                ...
                switch (node.type) {
                  ...
                  {serializedChildren}
                    ...
                    {serializedChildren}
                            ...
                            return (<li key={index} value={node?.value}>
                    {serializedChildren}
                  </li>);
                        }
                    }
                  ...
                  {serializedChildren}
                    ...
                    case 'link': {
                        ...
                        return (<CMSLink key={index} newTab={Boolean(fields?.newTab)} reference={fields.doc} type={fields.linkType === 'internal' ? 'reference' : 'custom'} url={fields.url}>
                  {serializedChildren}
                </CMSLink>);
                    }
                    default:
